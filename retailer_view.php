...
<?php
        ...
        echo '<p> EMAIL ID &emsp; &emsp; &emsp;&emsp;&emsp;&emsp;&emsp;' . $row['email'] . '<br><center><a href="pretailer.php"><button id="view" type="button" name="Logout" class="btn">View Details</button></a>
</p>';
        echo "     </div>
              </div>
            </div>";
